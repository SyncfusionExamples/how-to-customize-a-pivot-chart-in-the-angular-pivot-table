...
import { PivotViewModule, IDataOptions, IDataSet, DisplayOption } from '@syncfusion/ej2-angular-pivotview';
...
export class AppComponent {
  ...
  ngOnInit(): void {
    ...
    this.chartSettings = {
      chartSeries: { type: 'Pie', marker: { dataLabel: {visible:true}},
        legendShape:'Pentagon', explode: true },
